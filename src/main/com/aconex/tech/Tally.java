...
public class Tally {
    ...
    private HashMap<Character,ArrayList<Vote> > hm = new HashMap<> (); // The main map which keeps count of the active votes.
    private HashMap<Character,Integer> simpleMap = new HashMap<> ();  // A simpler map which is the gist of the above map.
    ...
    private void NormalizeMap(){
        if ( hm.size () < Candidate.getCandidateCount ()){
            ...
            Set<Character> hmSet = new HashSet<> (hm.keySet ());
            Set<Character> origSet = new HashSet<> (Candidate.candidates.keySet ());
    ...
    private void validateVote(Character eliminateCandidate){
        ...
        for( Vote v1 : eliminatedCandidateVoteList) {
            ...
            if (voteValid) {
                ...
                ArrayList<Vote> temp1 = new ArrayList<> (hm.get (changeToCandidate));
                temp1.add (v1);
    ...
    public ArrayList<Vote> getCurrentActiveVotes (){
        ArrayList<Vote> tempArrayList = new ArrayList<> ();
